    ...
    switch (this) {
      ...
      case RequestStatus.ordered:
        return switch (currentLanguage) {
          ...
          Language.es => "Pedido",
          Language.nl => "Besteld",
          Language.ru => "Заказано",
          Language.tr => "Sipariş edildi",
          Language.no => "Bestilt",
          Language.da => "Bestilt",
          Language.sv => "Beställd",
          Language.ar => "تم الطلب",
          Language.zh => "已订购",
          Language.th => "สั่งซื้อแล้ว",
          Language.vi => "Đã đặt hàng",
          Language.cs => "Objednáno",
          Language.el => "Παραγγέλθηκε",
          Language.uk => "Замовлено",
          Language.hr => "Naručeno",
          Language.ja => "注文済み",
          Language.pl => "Zamówione",
          Language.pt => "Encomendado",
          Language.ko => "주문됨",
          Language.ur => "آرڈر کیا گیا",
          Language.bg => "Поръчано",
          Language.af => "Bestel",
          Language.hi => "आदेश दिया गया",
        };
      case RequestStatus.awaitingUserConfirmation:
        return switch (currentLanguage) {
          ...
          Language.nl => "Wachten op bevestiging",
          Language.ru => "Ожидает подтверждения",
          Language.tr => "Onay bekleniyor",
          Language.no => "Venter på bekreftelse",
          Language.da => "Afventer bekræftelse",
          Language.sv => "Väntar på bekräftelse",
          Language.ar => "في انتظار التأكيد",
          Language.zh => "等待确认",
          Language.th => "รอการยืนยัน",
          Language.vi => "Đang chờ xác nhận",
          Language.cs => "Čeká na potvrzení",
          Language.el => "Αναμονή επιβεβαίωσης",
          Language.uk => "Очікує підтвердження",
          Language.hr => "Čeka potvrdu",
          Language.ja => "確認待ち",
          Language.pl => "Oczekuje na potwierdzenie",
          Language.pt => "Aguardando confirmação",
          Language.ko => "확인 대기 중",
          Language.ur => "تصدیق کی تصدیق",
          Language.bg => "Очаква потвърждение",
          Language.af => "Wag op bevestiging",
          Language.hi => "पुष्टि की प्रतीक्षा में",
        };
